...
function getAll(current, flag) {
    ...
    if (flag == 0) {
        $(".tablelist").append("<thead><tr align='center'><th width='10%' align='center'>编号</th><th width='25%' align='center'>部门名称</th><th width='35%' align='center'>部门备注</th><th width='15%' align='center'>运营部门</th><th width='15%'>撤销部门</th></tr></thead>");
    } else {
        ...
        success: function (mydata) {
            ...
            if (mydata == "9999") {
                ...
                $.each(mydata, function (index, xx) {
                    ...
                    next = xx.next;
                    allpages = xx.allPage;
                    // allpages = xx.countPage;
                    current = xx.current;
                    allcount = xx.allCount;
                    // allcount = xx.countNum;
                    console.log(up,next,current,allpages,allcount);
                    if (xx.pid != null) {
