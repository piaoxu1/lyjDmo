...
function commitItem() {
    $(".btn").bind("click", function () {
        ...
        console.log(hname);
        // $.ajaxFileUpload({
        //     url: 'http://localhost:8088/web_example_war_exploded/myht?type=add',
        ...
        //     }
        // });
        var mypart = "hthtname=" + hname + "";
        var i = layer.load(0);
        $.post('http://localhost:8088/web_example_war_exploded/myht?type=add',mypart,function(mydata){
            layer.close(i);
            if(mydata==1)
            {
